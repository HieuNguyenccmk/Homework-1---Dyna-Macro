...
classdef simulate
    methods(Static)
        ...
        function sim = grow(par,sol)            
            ...
            vsim = zeros(par.T*2,1);
            gsim = zeros(par.T*2,1);
            ...
            for j = 2:T*2 % Time loop.
                ...
                vsim(j) = vpol(kt_ind,A0_ind); 
                gsim(j) = gpol(kt_ind,A0_ind); 
                csim(j) = cpol(kt_ind,A0_ind);% Investment in period t.
